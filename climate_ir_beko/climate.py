...
climate_ir_beko_ns = cg.esphome_ns.namespace("climate_ir_beko")
BekoIrClimate = climate_ir_beko_ns.class_("BekoIrClimate", climate_ir.ClimateIR)
...
CONFIG_SCHEMA = climate_ir.CLIMATE_IR_WITH_RECEIVER_SCHEMA.extend(
    {
        cv.GenerateID(): cv.declare_id(BekoIrClimate),
        cv.Optional(
